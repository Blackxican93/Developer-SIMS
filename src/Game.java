...
public class Game<audioStream> implements java.io.Serializable {
    ...
    public Game() throws IOException, ParseException, UnsupportedAudioFileException, LineUnavailableException {
    ...
    public String runCommand(String inputstr) throws UnsupportedAudioFileException, LineUnavailableException, IOException {
